/*
yearly performance of products (year over year)

compare one year's sales to: 
- average sales of product
- previous year's sales of product
...
SELECT
    ...
    current_sales - LAG(current_sales) OVER (PARTITION BY product_name ORDER BY order_year ASC) AS difference_from_prev_year, 
